...
def main():
    ...
    # Step 4: Build raw SDK client using REST transport.
    # REST avoids the gRPC 16384-byte metadata hard limit that triggers the
    # "429 received metadata size exceeds hard limit" error.
    # NOTE: REST endpoint must NOT include the :443 port suffix.
    api_endpoint = (
